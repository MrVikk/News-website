...
const News = props => {
  ...
  const updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=in&category=${props.category}&apiKey=184abcbeac4e4e489609a727b159917c&page=${page}`
  ...
  const fetchMoreData = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=in&category=${
      props.category
    }&apiKey=184abcbeac4e4e489609a727b159917c&page=${page + 1}`
